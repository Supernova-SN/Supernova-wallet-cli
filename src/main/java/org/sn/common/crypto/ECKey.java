...
package org.sn.common.crypto;

import static org.sn.common.utils.BIUtil.isLessThan;
import static org.sn.common.utils.ByteUtil.bigIntegerToBytes;
...
import org.sn.common.crypto.jce.ECKeyAgreement;
import org.sn.common.crypto.jce.ECKeyFactory;
import org.sn.common.crypto.jce.ECKeyPairGenerator;
import org.sn.common.crypto.jce.ECSignatureFactory;
import org.sn.common.crypto.jce.SnCastleProvider;
...
public class ECKey implements Serializable {
  ...
  public ECKey(SecureRandom secureRandom) {
    this(SnCastleProvider.getInstance(), secureRandom);
  }
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory
            .getInstance(SnCastleProvider.getInstance())
