...
import org.sn.api.GrpcAPI.AccountNetMessage;
import org.sn.api.GrpcAPI.AccountResourceMessage;
import org.sn.api.GrpcAPI.AssetIssueList;
import org.sn.api.GrpcAPI.BlockExtention;
import org.sn.api.GrpcAPI.BlockList;
import org.sn.api.GrpcAPI.BlockListExtention;
import org.sn.api.GrpcAPI.DelegatedResourceList;
import org.sn.api.GrpcAPI.ExchangeList;
import org.sn.api.GrpcAPI.ProposalList;
import org.sn.api.GrpcAPI.TransactionApprovedList;
import org.sn.api.GrpcAPI.TransactionExtention;
import org.sn.api.GrpcAPI.TransactionList;
import org.sn.api.GrpcAPI.TransactionListExtention;
import org.sn.api.GrpcAPI.TransactionSignWeight;
import org.sn.api.GrpcAPI.WitnessList;
...
import org.sn.protos.Contract.AccountPermissionUpdateContract;
import org.sn.protos.Contract.AccountUpdateContract;
import org.sn.protos.Contract.AssetIssueContract;
import org.sn.protos.Contract.AssetIssueContract.FrozenSupply;
import org.sn.protos.Contract.ClearABIContract;
import org.sn.protos.Contract.CreateSmartContract;
import org.sn.protos.Contract.ExchangeCreateContract;
import org.sn.protos.Contract.ExchangeInjectContract;
import org.sn.protos.Contract.ExchangeTransactionContract;
import org.sn.protos.Contract.ExchangeWithdrawContract;
import org.sn.protos.Contract.FreezeBalanceContract;
import org.sn.protos.Contract.ParticipateAssetIssueContract;
import org.sn.protos.Contract.ProposalApproveContract;
import org.sn.protos.Contract.ProposalCreateContract;
import org.sn.protos.Contract.ProposalDeleteContract;
import org.sn.protos.Contract.SetAccountIdContract;
import org.sn.protos.Contract.TransferAssetContract;
import org.sn.protos.Contract.TransferContract;
import org.sn.protos.Contract.TriggerSmartContract;
import org.sn.protos.Contract.UnfreezeAssetContract;
import org.sn.protos.Contract.UnfreezeBalanceContract;
import org.sn.protos.Contract.UpdateAssetContract;
import org.sn.protos.Contract.UpdateEnergyLimitContract;
import org.sn.protos.Contract.UpdateSettingContract;
import org.sn.protos.Contract.VoteAssetContract;
import org.sn.protos.Contract.VoteWitnessContract;
import org.sn.protos.Contract.WithdrawBalanceContract;
import org.sn.protos.Contract.WitnessCreateContract;
import org.sn.protos.Contract.WitnessUpdateContract;
import org.sn.protos.Protocol.Account;
import org.sn.protos.Protocol.Account.AccountResource;
import org.sn.protos.Protocol.Account.Frozen;
import org.sn.protos.Protocol.Block;
import org.sn.protos.Protocol.BlockHeader;
import org.sn.protos.Protocol.ChainParameters;
import org.sn.protos.Protocol.ChainParameters.ChainParameter;
import org.sn.protos.Protocol.DelegatedResource;
import org.sn.protos.Protocol.DelegatedResourceAccountIndex;
import org.sn.protos.Protocol.Exchange;
import org.sn.protos.Protocol.InternalTransaction;
import org.sn.protos.Protocol.Key;
import org.sn.protos.Protocol.Permission;
import org.sn.protos.Protocol.Proposal;
import org.sn.protos.Protocol.ResourceReceipt;
...
import org.sn.protos.Protocol.Transaction.Result;
import org.sn.protos.Protocol.TransactionInfo;
import org.sn.protos.Protocol.TransactionInfo.Log;
import org.sn.protos.Protocol.TransactionInfo.code;
import org.sn.protos.Protocol.Vote;
import org.sn.protos.Protocol.Witness;
  ...
  public static String printInternalTransactionList(
    ...
    internalTransactions.forEach(internalTransaction -> {
          ...
          internalTransaction.getCallValueInfoList().forEach(token -> {
            ...
            callValueInfo.append("    TokenName(Default sn):\n");
            if (null == token.getTokenId() || token.getTokenId().length() == 0) {
              callValueInfo.append("    SN(YUN)");
            } else {
