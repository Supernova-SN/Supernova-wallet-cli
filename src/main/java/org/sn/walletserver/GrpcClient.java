...
import org.sn.api.GrpcAPI.AccountPaginated;
...
import org.sn.api.GrpcAPI.BlockLimit;
import org.sn.api.GrpcAPI.BlockList;
import org.sn.api.GrpcAPI.BlockListExtention;
import org.sn.api.GrpcAPI.BytesMessage;
import org.sn.api.GrpcAPI.DelegatedResourceList;
import org.sn.api.GrpcAPI.DelegatedResourceMessage;
import org.sn.api.GrpcAPI.EasyTransferAssetByPrivateMessage;
import org.sn.api.GrpcAPI.EasyTransferAssetMessage;
import org.sn.api.GrpcAPI.EasyTransferByPrivateMessage;
import org.sn.api.GrpcAPI.EasyTransferMessage;
...
import org.sn.api.GrpcAPI.PaginatedMessage;
import org.sn.api.GrpcAPI.ProposalList;
import org.sn.api.GrpcAPI.Return.response_code;
...
import org.sn.api.WalletExtensionGrpc;
import org.sn.api.WalletGrpc;
import org.sn.api.WalletSolidityGrpc;
...
//  }
  ...
  public Optional<TransactionListExtention> getTransactionsToThis2(byte[] address, int offset,
    ...
    //注意，如果配置文件中没有指明solidity节点的IP:port, 就不会初始化blockingStubExtension, 值为null引起异常。
    //结论，查找交易记录是从solidity节点获取数据。
    TransactionListExtention transactionList = blockingStubExtension
